...
The Gross Domestic Product (GDP) layer is calculated using coastal GDP data from the [National Ocean Economics Program](http://www.oceaneconomics.org/), and State-wide GDP from the [Bureau of Economic Analysis](http://www.bea.gov/).
